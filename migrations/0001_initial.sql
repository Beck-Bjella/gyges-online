-- 0001_initial — the schema as it stood at first deployment.
--
-- Migrations are applied in filename order, exactly once each, and recorded in
-- the schema_migrations table. Never edit a migration that has been applied
-- anywhere real: write a new one. See migrations/README.md.
--
